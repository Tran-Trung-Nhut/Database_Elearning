...
import ContributorCard from "@/components/Footer";
  ...
  return (
    <>
      ...
      <div className="w-full flex flex-col h-screen">
        <section className="bg-blue-600 flex flex-row items-center justify-between px-8 py-12">
          <div className="flex-1 pr-8">
            <h1 className="text-white text-5xl font-bold mb-4">Giới thiệu trang</h1>
            <p className="text-white text-lg leading-relaxed mb-6">
              Đây là một nền tảng học tập dành cho tất cả mọi người,
              nơi bạn có thể tham gia các khóa học chất lượng cao. Hãy cùng chúng
              tôi khám phá và nâng cao kỹ năng của bạn ngay hôm nay!
            </p>
            <button
              type="button"
